 ...
 */
   public class Heap<T> {
   // data fields
      private final Integer MAX_ARRAY_SIZE = 1000000;
    ...
    */
      public String toString() {
         String string = "";
         for (Integer i = 0; i <= indexOfLastElement; i++) {
    ...
    */
      ...
      // current item is child
         Integer indexOfChild = indexOfLastElement;
      // calculate index of parent
         Integer indexOfParent = (indexOfChild - 1) / 2;
      // "trickle up" the tree
    ...
    */
      private void trickleUp(Integer indexOfParent, Integer indexOfChild) {
         if ((indexOfParent >= 0)
    ...
    */
      private Integer compare(T item1, T item2) {
       //cast elements to java.lang.Comparable 
         java.lang.Comparable itemA = (java.lang.Comparable) item1;
         java.lang.Comparable itemB = (java.lang.Comparable) item2;
      //call compareTo() method
         Integer compareToResult = itemA.compareTo(itemB);
    ...
    * @param indexOfParent is the index of the parent node
    */
      private void trickleDown(Integer indexOfParent) {
      // calculate index of left and right children
         Integer indexOfLeftChild = 2 * indexOfParent + 1;
         Integer indexOfRightChild = 2 * indexOfParent + 2;
         Integer indexOfLargestOfThreeNodes = indexOfParent;
