...
/**
* SHOWS HOW TO PUT SEVERAL CLASSES IN ONE FILE
* Ask user for numerator & denominator 
    ...
    public class FractionCalculatorInOneFile{ 
       ...
       public static void main(String[] arguments) {   	   
         ...
         try{
            ...
            String message = fraction1.toString() 
                     + " + " + fraction2.toString()
                     +   " = " + fraction3.toString();	
...
//*********************************************************************
/**
* Interface is a list of method prototypes 
* that other classes must implement (like a contract)
* @author William McDaniel Albritton
*/
...
/** Implements the "FractionInterface" Interface.
...
* @author William McDaniel Albritton */
   ...
   * @exception IllegalFractionException if the denominator is zero
   */   
       public Fraction(Integer numeratorParameter, Integer denominatorParameter) throws IllegalFractionException{
   ...
   * @return a 3rd Fraction The Is The Quotient */
   ...
   /**Euclid's algorithm from 200 BCE, which determines 
   * the greatest common divisior of two numbers.
