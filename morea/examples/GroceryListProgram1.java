 ...
 *  Version 1: Has code for main() and displayMenu() methods
       ...
       public static void main(String[] commandlineArguments) {	
        //Error Checking For 2 Command Line Arguments..
         ...
         //read grocery items from file & store in array for grocery list
            String groceryList[] = GroceryListProgram1.readFromFile(commandlineArguments[0]);
         ...
         //if the user does not want to QUIT, keep looping
            ...
            GroceryListProgram1.writeToFile(commandlineArguments[1], groceryList, size);
         }//end of "else" 
      }//end of main() method	
