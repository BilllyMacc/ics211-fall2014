...
/**
 *  More Big-O examples (n is the 1st commandline argument)
 *  Input these numbers: 10, 100, 1000, 10000, etc.
 *  You will notice that it takes longer & longer for the program to run.
 *  And the loops with a large Big-O will quickly increase their running time,
 *  as compared to those loops with a small Big-O.
 *  
