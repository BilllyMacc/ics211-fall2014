/**
 * A PriorityQueue class roughly based on Java 5.0 API's PriorityQueue class
 * 
 * @copyright 2007 William Albritton
 */
public class PriorityQueue<T extends java.lang.Comparable<T>> implements QueueInterface<T>{
	 ...
	 * 
	 * @param element
	 *            is offered to the PriorityQueue
	 * @return true if it was possible to offer the element to PriorityQueue,
	 *         else false
	 */
	...
	/**
	 * Retrieves and removes the from the top of PriorityQueue, or null if
	...
	/**
	 * Retrieves, but does not remove, from the top of PriorityQueue, or null if
	 * PriorityQueue is empty
	 * 
	 * @return the top of PriorityQueue, or null if PriorityQueue is empty
	 */
