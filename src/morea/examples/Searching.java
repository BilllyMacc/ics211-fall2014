...
/**
 * Searches for a Fraction with an array of Fractions.
 * Enter two numbers on commandline for your guess.
 * 1st argument is numerator, 2nd argument is denominator.
 * Outputs the index of your guess (if correct).
 * If guess correct, reduces Fraction to lowest terms, sorts, and outputs again.
 * If guess incorrect, sets 1st element to your guess, sorts, and outputs again.
 ...
 */
   ...
   * @return -1, if element not found; index of element, if found
   */   
       private static Integer binarySearch(Comparable [] array, Comparable guess, Integer start, Integer end){     
